...
RedirectMatch 301 ^/(docs/latest-release)/intro/setup/(on-prem)/(vmware|proxmox)/installation-guides/((vmware|proxmox)-installation-guide)(|/.*)$ https://www.iguazio.com/$1/cluster-mgmt/deployment/$2/$3/$4$6
RedirectMatch 301 ^/(docs/latest-release)/intro/setup/(on-prem)/(vmware|proxmox)/installation-guides(|/.*)$ https://www.iguazio.com/$1/cluster-mgmt/deployment/$2/$3/$3-installation-guide$4
